...
USE master
GO
DROP  DATABASE HalloCreativeDB;
GO

CREATE TABLE [Service Offers] (
  [Service ID] int,
  [Text Description] varchar(50),
...
CREATE TABLE [Services] (
  ...
  [Service Scale] varchar(20),
  [Service Vendor] varchar(30),
  [Service Description] varchar(45),
  [Retainer Status] bool,
...
CREATE INDEX [PK, FK] ON  [Order Details] ([Order Number], [Service Code]);

CREATE TABLE [Offices] (
  [Office Code] int,
  [City] varchar(25),
  [Phone Number] varchar(15),
  [Address Line 1] varchar(45),
  [Address Line 2] varchar(45),
  [Country] varchar(25),
  [State] varchar(30),
...
CREATE TABLE [Customers] (
  ...
  [Contact Last Name] varchar(30),
  [Contact First Name] varchar(30),
  [Phone] varchar(15),
  [Address Line 1] varchar(45),
  [Address Line 2] varchar(45),
  [City] varchar(25),
